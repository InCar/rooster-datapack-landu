...
//    @Test
    public void testParsePositionString() {
        ...
        Assert.assertEquals(-116.362946, LanduDataPackUtil.parsePositionString("W116.362946"), 0);
        Assert.assertEquals(-40.079099, LanduDataPackUtil.parsePositionString("S40.079099"), 0);
    }
}
